export default {
  ...
  locale: "hr-HR",
  langue: "croate",
  pied: "Green Solutions · Tržišna studija Hrvatska",
  ...
  usages: {
    ...
    data: [
      {
        ...
        labels: ["Javna vodoopskrba", "Industrija", "Poljoprivreda"],
        values: [62, 25, 13],
      },
    ],
    ...
    reading: {
      head: "Što to znači",
      body:
        "Suprotno mediteranskim zemljama, poljoprivreda ovdje zahvaća najmanji dio vode — ne zato što joj ne treba, nego zato što je nema čime dovesti na parcelu.\n\nOgraničenje stoga nije količina vode u zemlji, nego njezina dostupnost korijenu u trenutku kada je biljci potrebna.",
    },
  },
    ...
    data: [
      {
        ...
        labels: ["Kukuruz", "Pšenica", "Šećerna repa", "Ječam", "Soja"],
        values: [2.0, 0.9, 0.9, 0.3, 0.25],
      },
    ],
  ...
  solutions: {
    ...
    note:
      "Oba se proizvoda prodaju odvojeno, ali su osmišljena da se pojačavaju: hidroretenter produljuje dostupnost vode, a gnojivo tu dostupnu vodu vrednuje bez degradacije tla. Na oborinskoj parceli, gdje nema navodnjavanja koje bi se moglo pojačati, prvi je od njih jedina poluga koja preostaje.",
  },
  ...
  economies: {
    ...
    data: [
      {
        name: "Donja granica (%)",
        labels: ["Kap po kap", "Rasprskivanje", "Pivot", "Gravitacijsko"],
        values: [40, 45, 50, 55],
      },
      {
        name: "Gornja granica (%)",
  ...
  deploiement: {
    ...
    note:
      "Pravilo doziranja svugdje je isto: 3 grama po litri korisne zemlje. Ono što se mijenja od gospodarstva do gospodarstva jest obujam tla koji korijenje stvarno prožima.",
  },
  ...
  risques: {
    ...
    note:
      "Analiza akrilamida (laboratorij Polymex, ISO 9001, udio niži od 3,0 µg/g), screening REACH / SVHC (SGS) i certifikat SOHISCERT koji vrijedi do 4. rujna 2027. dostupni su na zahtjev. Mjere ruralnog razvoja iz sredstava EU mogu sufinancirati ulaganje u poboljšanje tla.",
  },
