export default {
  ...
  locale: "fr-BJ",
  langue: "Français",
  pied: "Green Solutions · Dossier marché Bénin",
  ...
  chiffres: {
    ...
    items: [
      { value: "≈ 15 M", label: "d'habitants, une population jeune en forte croissance" },
      { value: "≈ 24 %", label: "du PIB provient de l'agriculture (2,3 M d'actifs)" },
      { value: "637 000 t", label: "de coton produites en 2024-2025, 1er rang en Afrique de l'Ouest" },
      { value: "652 000 t", label: "de soja attendues sur la même campagne, filière en plein essor" },
    ],
    note:
  ...
  solutions: {
    ...
    note:
      "Les deux produits se vendent séparément mais ont été conçus pour se renforcer : l'hydro-rétenteur prolonge la disponibilité de l'eau, le fertilisant valorise cette eau sans dégrader un sol que l'extension des surfaces met déjà sous pression.",
  },
