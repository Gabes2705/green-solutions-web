export default {
  ...
  locale: "fr-GP",
  langue: "Français",
  pied: "Green Solutions · Dossier marché Guadeloupe",
  ...
  chiffres: {
    ...
    items: [
      { value: "≈ 384 000", label: "habitants (2023), population en léger recul" },
      { value: "60 %", label: "de l'eau potable perdue avant d'arriver au robinet, à cause des fuites du réseau" },
      { value: "-75 %", label: "de déficit de pluie sur la Grande-Terre en juin 2026, deuxième juin le plus sec depuis 1991" },
      { value: "1 hab./4", label: "n'a pas l'eau au robinet tous les jours, hors même tout épisode de sécheresse" },
    ],
    note:
  ...
  solutions: {
    ...
    note:
      "Sur une île où l'eau se perd autant dans le réseau qu'au champ, l'intérêt de nos deux produits n'est pas seulement agronomique : c'est de rendre chaque exploitation moins dépendante d'une ressource publique déjà sous tension.",
  },
