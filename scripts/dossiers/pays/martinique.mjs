export default {
  ...
  locale: "fr-MQ",
  langue: "Français",
  pied: "Green Solutions · Dossier marché Martinique",
  ...
  chiffres: {
    ...
    items: [
      { value: "≈ 360 000", label: "habitants (2023), population en recul" },
      { value: "94 %", label: "de l'eau consommée provient directement des rivières" },
      { value: "≈ 3 jours", label: "de capacité de stockage disponible pour l'ensemble du territoire" },
      { value: "20–60 %", label: "des normales saisonnières de pluie seulement, en juin 2026" },
    ],
    note:
  ...
  solutions: {
    ...
    note:
      "Quand le territoire n'a que trois jours de réserve, retenir l'eau à la racine plutôt que de compter sur le réseau ou la rivière devient un levier direct, pas seulement un gain de confort.",
  },
