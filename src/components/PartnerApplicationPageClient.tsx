...
const COPY: Record<Lang, {
  ...
  ca: { eyebrow: "Col·laboracions", title: "Feu-vos soci", lede: "Presenteu-nos la vostra empresa i el vostre projecte de col·laboració.", promise: "Us respondrem en un termini de 24 hores.", name: "Nom i cognoms", company: "Empresa", website: "Lloc web", address: "Adreça completa", city: "Ciutat", country: "País", postal: "Codi postal", phone: "Número de telèfon", email: "Adreça electrònica", comment: "Comentari", send: "Enviar la sol·licitud", sending: "Enviant…", success: "La vostra sol·licitud s'ha enviat correctament. Us respondrem en un termini de 24 hores.", error: "No s'ha pogut enviar. Torneu-ho a provar o escriviu-nos directament.", back: "Tornar al lloc" },
};
